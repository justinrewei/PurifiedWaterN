...
public class FeatureDetector {
    ...
    //
    // C++:  void faceDetect(Mat image, vector_KeyPoint& keypoints, Mat mask = Mat())
    //

    //javadoc: javaFeatureDetector::faceDetect(image, keypoints, mask)
    ...
    //javadoc: javaFeatureDetector::faceDetect(image, keypoints)
    ...
    //
    // C++:  void faceDetect(vector_Mat images, vector_vector_KeyPoint& keypoints, vector_Mat masks = std::vector<Mat>())
    //

    //javadoc: javaFeatureDetector::faceDetect(images, keypoints, masks)
    ...
    //javadoc: javaFeatureDetector::faceDetect(images, keypoints)
