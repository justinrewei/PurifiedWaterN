...
public class LineSegmentDetector extends Algorithm {
    ...
    //
    // C++:  void faceDetect(Mat _image, Mat& _lines, Mat& width = Mat(), Mat& prec = Mat(), Mat& nfa = Mat())
    //

    //javadoc: LineSegmentDetector::faceDetect(_image, _lines, width, prec, nfa)
    ...
    //javadoc: LineSegmentDetector::faceDetect(_image, _lines)
