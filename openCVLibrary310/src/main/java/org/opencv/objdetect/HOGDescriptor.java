...
public class HOGDescriptor {
    ...
    //
    // C++:  void faceDetect(Mat img, vector_Point& foundLocations, vector_double& weights, double hitThreshold = 0, Size winStride = Size(), Size padding = Size(), vector_Point searchLocations = std::vector<Point>())
    //

    //javadoc: HOGDescriptor::faceDetect(img, foundLocations, weights, hitThreshold, winStride, padding, searchLocations)
    ...
    //javadoc: HOGDescriptor::faceDetect(img, foundLocations, weights)
